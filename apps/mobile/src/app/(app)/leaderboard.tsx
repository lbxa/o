      ...
      <View className="flex px-4 w-full justify-center mt-5">
        <Card>
          <Text className="text-xl font-bold mb-2">
            Welcome to GymX's weekly challenge
          </Text>
          <Text>
            Take on the wall sit challenge! Hold the position as long as you
            can. The top male and female with the longest wall sits will each
            win three free classes.
          </Text>
        </Card>
        ...
        {leaderboardData.map((person, rank) => {
          return <LeaderboardCard key={rank} {...person} />;
        })}
