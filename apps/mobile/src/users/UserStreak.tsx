...
const DEFAULT_COLORS = tailwind.theme.colors;
...
export const UserStreak = ({ streak }: { streak: number }) => {
  ...
  const colorMatrix = {
    orange: {
      ...
      fill: isDark ? COLORS.ivory.DEFAULT : DEFAULT_COLORS.orange[400],
    },
    red: {
      bg: "bg-red-200 dark:bg-red-500",
      text: "text-red-500 dark:text-ivory",
      fill: isDark ? COLORS.ivory.DEFAULT : DEFAULT_COLORS.red[500],
    },
    indigo: {
    ...
    gray: {
      ...
      fill: isDark ? COLORS.ivory.DEFAULT : DEFAULT_COLORS.gray[500],
    },
  };
