...
export type ChallengeRootQuery$data = {
  readonly viewer: {
    readonly challenge: {
      readonly " $fragmentSpreads": FragmentRefs<"ChallengeActivityTopResultsFragment_challenge" | "ChallengeFragment">;
    } | null | undefined;
  } | null | undefined;
};
...
(node as any).hash = "da37346e1403fbfe5b0d5246fa025ef0";
